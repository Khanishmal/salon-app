...
import 'vendor_apply_screen.dart';
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
            image: AssetImage('assets/hero-salon.jpg'), fit: BoxFit.cover),
      ),
      child: Container(
          ...
          Wrap(
            ...
            children: services
                .map((s) => _buildServiceCard(
                    s['icon'] as IconData, s['title'] as String))
                .toList(),
          ),
        ],
      ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
            colors: [Color(0xFFFBC280), Color(0xFFF2845C)]),
        borderRadius: BorderRadius.circular(30),
      ),
      child: Column(
        children: [
          const Text("Ready to Glow?",
              style: TextStyle(
                  fontSize: 36,
                  color: Colors.white,
                  fontWeight: FontWeight.bold)),
                  ...
                  children: [
                    Text("GlowSalon",
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                    SizedBox(height: 15),
                    Text("Your luxury destination for beauty.",
                        style: TextStyle(color: Colors.grey)),
                  ],
                ),
              ),
              const SizedBox(width: 40),
              _footerColumn(context, "Quick Links",
                  ["About Us", "Contact", "Become a Vendor"]),
            ],
          ),
          const Divider(color: Colors.white10, height: 60),
          const Text("© 2026 GlowSalon. All rights reserved.",
              ...
              onTap: () {
                if (item == "Become a Vendor") {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => VendorApplyScreen()));
                }
              },
              child: Padding(
