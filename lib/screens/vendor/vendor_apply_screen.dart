//lib/screens/vendor_apply_screen.dart
              ...
              children: [
                ...
                const Text("Become a Vendor",
                    style: TextStyle(
                        ...
                        fontFamily: 'Serif')),
                const Text("Apply to offer your services on GlowSalon",
                    style: TextStyle(color: Colors.grey)),
                const SizedBox(height: 30),
                _buildLabelField("Full Name", _nameController,
                    "Enter your full name", Icons.person_outline),
                _buildLabelField("Business Name", _businessController,
                    "Your salon/business name", Icons.store_outlined),
                _buildLabelField("Email", _emailController, "Enter your email",
                    Icons.email_outlined),
                _buildLabelField("Password", _passwordController,
